...
const AddProduct = () => {
    ...
    const [getProductData,setProduct]=useState([])
    ...
    const [error, handleSubmit, isPending] = useActionState(
        async (previousState, formData) => {
            ...
            errors.status = formValidation(formData.get("status"), "Status", { required: true });
            ...
            try {
                const response = await HTTP("PUT", `/api/products/${id}`, formDataObject, "");
                toast.success(response.message);
                navigate("/products"); // Navigate after success
                return { ...previousState, successMessage: "Product updated successfully!" };
            } catch (err) {
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
                ...
                <form onSubmit={onSubmit} className="mt-6 space-y-6">
                      ...
                      <div>
                        ...
                        <Select name="category_id" data={getCategoryData} value={getProductData.category_id} 
                        
                        
                        onChange={(event) => {
                            setProduct({ ...getCategoryData, category_id: event.target.value }); // ✅ State update ho raha hai
                          }}
                    ...
                    <div>
                        ...
                        <Input type="text" name="name"  defaultValue={getProductData.name} />
                        {error.name && <span className="text-red-600 text-sm">{error.name}</span>}
                    </div>

                    <div>
                        <Label>Description:</Label>
                        <Textarea name="description" defaultValue={getProductData.description} placeholder="Describe your product" />
                    ...
                    <div>
                        ...
                        <Input 
                            ...
                            min={1} 
                            // max={10000} 
                            defaultValue={getProductData.price}
                            maxLength={7}
                    ...
                    <div>
                        <Label>Brand:</Label>
                        <Input type="text" name="brand"  defaultValue={getProductData.brand}/>
                    ...
                    <div>
                        ...
                        <Input 
                            ...
                            max={999} 
                            maxLength={5}
                            defaultValue={getProductData.discount}
                        onChange={(e) => console.log(e.target.value)}
                        />
                    ...
                    <div>
                        ...
                        <Input 
                            ...
                            max={999} 
                            maxLength={3}
                            defaultValue={getProductData.stock}
                        onChange={(e) => console.log(e.target.value)}
                        />
                    ...
                    {/* <div>
                        <Label>SKU:</Label>
                        <Input type="text" name="sku" defaultValue={getProductData.sku} />
                        {error.sku && <span className="text-red-600 text-sm">{error.sku}</span>}
                    </div> */}

                    <div>
                        <Label>Slug:</Label>
                        <Input type="text" name="slug" defaultValue={getProductData.slug} />
                    ...
                    <div>
                        <Label>Status:</Label>
                        <Select name="status" value={getProductData.status} data={statusCategories} defaultName="Select Status" />
